...
- The Human In The Loop column additionally renders an add-task control in both the standard board header and the swim lane header/cell; no other column has one
